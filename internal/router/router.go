...
import (
	...
	// Core modules
	"tuai/internal/modules/core/api_key"
	"tuai/internal/modules/core/approval"
	"tuai/internal/modules/core/auth"
	"tuai/internal/modules/core/branch"
	"tuai/internal/modules/core/client"
	"tuai/internal/modules/core/company"
	"tuai/internal/modules/core/role"
	"tuai/internal/modules/core/translation_overrides"
	"tuai/internal/modules/core/user"
	userRepo "tuai/internal/modules/core/user/repository"

	"tuai/internal/shared/audit"
	"tuai/internal/shared/authz"
	sharedRedis "tuai/internal/shared/redis"

	pkgfirebase "tuai/pkg/firebase"
	"tuai/pkg/logger"
...
func Setup(router *gin.Engine, db *pgxpool.Pool, cfg *config.Config) {
	...
	router.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"http://localhost:5173", "http://localhost:3000", "http://localhost:3001", "http://localhost:8081", "https://app.tuai.id", "https://jesuit.venturo.pro"},
