...
// consumer for NBS. (TODO: extract to shared `iqplus_subscriber` —
// 6th near-identical subscriber. Time to consolidate after this one.)
package subscriber
...
type Config struct {
	...
	DurableName    string // e.g. nbs-aggregator
	FilterSubject  string // e.g. idx.nbs.>
...
// DefaultConfig fills the safe operational knobs for NBS.
func DefaultConfig() Config {
	return Config{
		ClientName:     "nbs-consumer",
		Stream:         "IDX_META",
		DurableName:    "nbs-aggregator",
		FilterSubject:  "idx.nbs.>",
...
func (s *Subscriber) Start(ctx context.Context) error {
	...
	logger.Log.Info("nbs subscriber ready",
