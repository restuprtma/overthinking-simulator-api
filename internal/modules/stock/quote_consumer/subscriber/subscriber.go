...
// consumer for the Quote consumer. Mirrors the OHLCV subscriber pattern
// (TODO: extract to shared `iqplus_subscriber` once 3rd consumer needs it).
package subscriber
...
type Config struct {
	...
	Token          string
	ClientName     string
	Stream         string        // e.g. IDX_QUOTE
	DurableName    string        // e.g. quote-state-cache
	FilterSubject  string        // e.g. idx.quote.>
...
// DefaultConfig fills the safe operational knobs for Quote consumption.
func DefaultConfig() Config {
	return Config{
		ClientName:     "quote-consumer",
		Stream:         "IDX_QUOTE",
		DurableName:    "quote-state-cache",
		FilterSubject:  "idx.quote.>",
		AckWait:        30 * time.Second,
		MaxAckPending:  10_000, // Quote rate higher than Trade
...
func (s *Subscriber) Start(ctx context.Context) error {
	...
	logger.Log.Info("quote subscriber ready",
