...
// consumer for tradedone. (TODO: extract to shared `iqplus_subscriber`
// — this is the 5th near-identical subscriber.)
package subscriber
...
type Config struct {
	...
	DurableName    string // e.g. tradedone-volume-profile
	FilterSubject  string // e.g. idx.tradedone.>
...
func DefaultConfig() Config {
	return Config{
		...
		Stream:         "IDX_TICK",
		DurableName:    "tradedone-volume-profile",
		FilterSubject:  "idx.tradedone.>",
...
func New(cfg Config, h Handler) *Subscriber {
	...
	if cfg.ClientName == "" {
		cfg.ClientName = "tradedone-consumer"
	}
...
func (s *Subscriber) Start(ctx context.Context) error {
	...
	logger.Log.Info("tradedone subscriber ready",
