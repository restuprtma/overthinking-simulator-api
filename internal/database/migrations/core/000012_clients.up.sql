...
-- CORE SCHEMA - CLIENTS
-- =====================================================
-- Migration 012: Registration-level tenant. One row per signup.
-- Also wires companies.client_id (NOT NULL FK) and backfills any
-- existing companies with a derived client.
--
-- Design notes:
